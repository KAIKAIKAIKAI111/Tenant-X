...
<head>
  ...
  <title>Tenant X: Rental Property Management System</title>
          ...
          <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                <div class="form-group">
                    <label>Tenants' Contact Number</label>
            ...
            <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Submit Tenants' Details</button>
            </div>
          </div>
          </form>
